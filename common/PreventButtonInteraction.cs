...
//参考:https://nekojara.city/unity-input-system-prevent-button-mashing
...
/// ボタンの連打を防ぐ.
/// </summary>
public class PreventButtonInteraction : IInputInteraction
{
    ...
    public static void Initialize()
    {
        ...
        InputSystem.RegisterInteraction<PreventButtonInteraction>();
    }
